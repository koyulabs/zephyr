...
const dropDownBase = {
  ...
  DropdownButton: "",
  DropdownItems:
    "absolute z-10 w-56 mt-2 overflow-hidden bg-white border border-gray-200 divide-y divide-gray-100 rounded-md shadow-lg outline-none",
};
  ...
  return merge(
    {
      ...
      disabled: {
        ...
        DropdownItem: {
          BASE:
            "text-gray-300 flex justify-between w-full px-4 py-2 text-sm leading-5 text-left cursor-not-allowed",
          active: "",
          inactive: "",
        },
      },
