...
export default function Button(userTheme: any = null) {
  return merge(
    {
      ...
      disabled: `${buttonDefault} focus:ring-0! focus:ring-offset-0! border-transparent bg-gray-100 dark:bg-gray-700 cursor-not-allowed`,
      size: {
    ...
    userTheme ? userTheme.Button : null
  );
}
